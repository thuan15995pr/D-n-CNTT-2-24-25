...
# Generate folder name with current time
...
def output_results_and_errors_multiple(predicted_data, true_data, true_data_base, prediction_len, file_name,
    ...
    ### Output predicted and true values
    ...
    ### Output eval
    # Truncate data to ensure consistent length
